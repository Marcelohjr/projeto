        ...
        <div class="columns">
          <aside class="column is-2 aside">
            ...
            ?>
                ...
                <ul class="menu-list">
                  <li><a class="is-active" id="dados" onclick="transicaoMeusDados();"><span class="icon is-small"><i class="fa fa-database"></i></span> Meus Dados</a></li>
                  <li><a class="" id="compras" onclick="transicaoCompras();"><span class="icon is-small"><i class="fa fa-shopping-basket"></i></span> Compras</a></li>
                  <li><a class="" id="favoritos" onclick="transicaoFavoritos();"><span class="icon is-small"><i class="fa fa-star-o"></i></span> Favoritos</a></li>
                </ul>
                <br><br><br><br><br>
            </nav>
          </aside>
