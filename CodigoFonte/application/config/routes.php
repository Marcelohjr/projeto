...
$route['cadastrar'] = 'LandingPage/ShowRegistrar';
$route['registrar'] = 'LandingPage/Registrar';
$route['sair'] = 'LandingPage/Logout';
$route['detalhe/(:num)'] = 'LandingPage/ShowProdutoDetalhe/$1';
$route['cadastrarcategoria'] = 'LandingPage/SetCategorias';
$route['cadastrarprodutos'] = 'LandingPage/SetProdutos';
$route['valida'] = 'LandingPage/ValidaLogin';
$route['admin'] = 'LandingPage/Administrator';
$route['profile/(:num)'] = 'LandingPage/ShowTheProfile/$1';
$route['setcomentario/(:num)/(:num)'] = 'LandingPage/Comentar/$1/$2';
...
$route['addcarrinho/(:num)'] = 'LandingPage/AddToCart/$1';
